package com.company.backend.listener;
...
public class DemoDataInitializer {
    ...
    private List<User> initUsers(List<Step> steps, List<Department> departments) {
        ...
        user.setPicture(uploadPicture("com/company/backend/demo/" , "alice.png"));
        ...
        user.setPicture(uploadPicture("com/company/backend/demo/" , "james.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/backend/demo/", "mary.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/backend/demo/", "linda.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/backend/demo/", "susan.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
        ...
        user.setPicture(uploadPicture("com/company/backend/demo/", "bob.png"));
        saveContext.saving(user);
        list.add(user);
        for (Step step : steps) {
            UserStep userStep = dataManager.create(UserStep.class);
