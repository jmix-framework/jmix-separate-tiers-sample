...
To support serialization of `User` entity to JSON for storing OAuth2 tokens in the database, the backend application defines a mixin class and uses it in the `JdbcOAuth2AuthorizationServiceObjectMapperCustomizer` bean:
